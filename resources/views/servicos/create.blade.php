...
<form action="{{ route('servicos.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col" >
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control @if($errors->has('nome')) is-invalid @endif" name="valor" placeholder="Valor em R$" value="{{old('valor')}}" />
                    @if($errors->has('valor'))
                            <div class='invalid-feedback'>
                                {{ $errors->first('valor') }}
                            </div>
        ...
        <div class="row">
            <div class="col">
                <a href="{{route('servicos.index')}}" class="btn btn-secondary btn-block align-content-center">
