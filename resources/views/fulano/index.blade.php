...
<body>
    ...
    <div class="container">
        <div id="agenda" data-route-load-events="{{ route('routeLoadEvents') }}" data-route-load-store="{{ route('routeEventStore') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('evento.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-success saveEvent">Salvar</button>
                        <button type="submit" class="btn btn-warning">Editar</button>
                        <button type="submit" class="btn btn-danger deleteEvent">Excluir</button>
